...
async def create_docs_pull_request(
    ...
    try:
        ...
        title = f"docs: auto-resolve drift for PR #{pr_number}"
        body = (
            f"## Automated Documentation Update\n\n"
            f"This PR was auto-generated by **Delta** to resolve documentation "
            f"drift detected in PR #{pr_number}.\n\n"
            f"### Changes Summary\n{changes_summary}\n\n"
            f"---\n"
            f"🔗 **Original PR:** [{repo_full_name}#{pr_number}]"
            f"(https://github.com/{repo_full_name}/pull/{pr_number})\n\n"
            f"_This PR was automatically created by the Delta documentation workflow._"
        )
